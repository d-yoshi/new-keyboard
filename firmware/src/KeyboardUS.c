...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_LEFTSHIFT, KEY_LEFT_GUI, KEY_LEFT_FN, KEY_SPACEBAR, KEY_BACKSPACE, KEY_ESCAPE, KEY_ESCAPE, KEY_ENTER, KEY_RIGHTALT, KEY_RIGHT_FN, KEY_RIGHT_GUI, KEY_RIGHTSHIFT
};
