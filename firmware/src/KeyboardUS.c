...
{
    KEY_GRAVE_ACCENT, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10, KEY_F11, KEY_EQUAL,
    KEY_LEFTALT, KEY_F1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_F12, KEY_BACKSLASH,
    ...
    KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_INSERT, KEY_HOME, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON,
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_DELETE, KEY_END, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTSHIFT, KEY_LEFT_GUI, KEY_LEFTALT, KEY_LEFT_FN, KEY_SPACEBAR, KEY_BACKSPACE, KEY_ESCAPE, KEY_ENTER, KEY_RIGHTALT, KEY_RIGHT_FN, KEY_RIGHT_GUI, KEY_RIGHTSHIFT
};
